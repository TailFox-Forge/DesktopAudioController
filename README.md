...
1. [릴리즈 페이지](https://github.com/TailFox-Forge/DesktopAudioController/releases)에서 `DesktopAudioController-v0.18.1-win-x64.zip`을 다운로드합니다.
2. 원하는 위치에 압축을 풉니다.
...
```bash
sha256sum -c DesktopAudioController-v0.18.1-win-x64.zip.sha256
```
