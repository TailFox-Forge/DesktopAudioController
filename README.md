...
최신 GitHub 프리릴리즈: v0.6.0-preview3
최신 로컬 배포 검증: v0.6.0-preview3
```
...
```bash
bash scripts/publish-win-x64.sh v0.6.0-preview3-local
```
...
- [v0.6.0-preview3](https://github.com/TailFox-Forge/desktop-audio-controller/releases/tag/v0.6.0-preview3)
