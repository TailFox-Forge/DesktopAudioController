...
```text
기준 버전: v0.9.0
개발 단계: Phase 9 완료 / Phase 10 준비
런타임: .NET 8 / WPF / Windows 전용
배포 형태: win-x64 self-contained single-file zip
최신 프리릴리즈: https://github.com/TailFox-Forge/DesktopAudioController/releases/tag/v0.9.0
최근 확인 사항:
...
```bash
bash scripts/publish-win-x64.sh v0.9.0-local
```
