...
1. [릴리즈 페이지](https://github.com/TailFox-Forge/DesktopAudioController/releases)에서 `DesktopAudioController-v0.16.6-win-x64.zip`을 다운로드합니다.
2. 원하는 위치에 압축을 풉니다.
...
```bash
bash scripts/publish-win-x64.sh v0.16.6-local
```
