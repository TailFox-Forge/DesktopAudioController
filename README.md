...
최신 프리릴리즈: https://github.com/TailFox-Forge/DesktopAudioController/releases/tag/v0.10.2
최근 확인 사항:
...
- 업데이트/트레이/빈 상태/오류 상태 문구 UX 마감 반영
- 업데이트 방식은 zip 다운로드 후 압축 해제 / 덮어쓰기 기준
- 기본 업데이트 채널을 stable only로 고정하고, prerelease opt-in 설정 추가
- v1.0.0 출고 기준 / 회귀 검증 체크리스트 문서화 완료
- non-UWP 프로그램 아이콘 로딩 개선 반영
- Phase 11 현재 상태: P11-1 / P11-2 / P11-4 완료, P11-3 대기
```
...
```bash
bash scripts/publish-win-x64.sh v0.10.2-local
```
