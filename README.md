...
최신 GitHub 프리릴리즈: v0.7.3-preview11
최신 로컬 배포 검증: v0.7.3-preview11
```
...
```bash
bash scripts/publish-win-x64.sh v0.7.3-preview11-local
```
...
- [v0.7.3-preview11](https://github.com/TailFox-Forge/DesktopAudioController/releases/tag/v0.7.3-preview11)
